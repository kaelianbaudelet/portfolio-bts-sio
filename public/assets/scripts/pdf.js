        ...
        var __webpack_modules__ = [
                ...
                (__unused_webpack_module, exports, __w_pdfjs_require__) => {
                    ...
                    if (_util.isNodeJS && "function" == typeof require) {
                        ...
                        PDFWorkerUtil.fallbackWorkerSrc = "/assets/scripts/pdf.worker.min.js";
                        ...
                        setEditingState(t) {
                            if (t) {
                                ...
                                this.#Ht({
                                    ...
                                    isEmpty: this.#Gt(),
                                    hasSomethingToUndo:
                                        this.#at.hasSomethingToUndo(),
                                    hasSomethingToRedo:
                                        this.#at.hasSomethingToRedo(),
                                    hasSelectedEditor: !1,
                                });
                            } else {
                                this.#Lt();
                    ...
                    class CanvasExtraState {
                        ...
                        getPathBoundingBox(t = a.PathType.FILL, e = null) {
                            ...
                            if (t === a.PathType.STROKE) {
                                ...
                                const t =
                                        s.Util.singularValueDecompose2dScale(e),
                    ...
                    e.SVGGraphics = class SVGGraphics {
                        ...
                        _makeTilingPattern(t) {
                            const e = t[1],
                                ...
                                [A, _] =
                                    n.Util.singularValueDecompose2dScale(s),
                                v = h * A,
                                y = c * _,
                                S =
                    ...
                    class FreeTextEditor extends a.AnnotationEditor {
                        ...
                        #qe(t) {
                            ...
                            this.addCommands({
                                ...
                                mustExec: !0,
                                type: s.AnnotationEditorParamsType
                                    .FREETEXT_SIZE,
                        ...
                        #Ke() {
                            const t =
                                this.editorDiv.getElementsByTagName("div");
                ...
                (t, e, i) => {
                    ...
                    class PopupAnnotationElement extends AnnotationElement {
                        constructor(t) {
                            ...
                            super(t, {
                                isRenderable:
                                    AnnotationElement._hasPopupData(e),
                            });
                            this.elements = i;
                        }
                        render() {
                    ...
                    class PopupElement {
                        ...
                        render() {
                            ...
                            r.className = "popup";
                            if (this.#je) {
                                const t = (r.style.outlineColor =
                                    s.Util.makeHexColor(...this.#je));
                                if (
                                    CSS.supports(
                                        "background-color",
